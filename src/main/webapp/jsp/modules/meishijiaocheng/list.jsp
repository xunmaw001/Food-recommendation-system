...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">美食教程管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>美食教程列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var jiaochengshipinCell  = document.createElement('td');

						  var jiaochengshipinMedia = document.createElement('button');
			  jiaochengshipinMedia.setAttribute('class','btn-table')
			  jiaochengshipinMedia.innerHTML = '播放';
			  var jiaochengshipinAttr = "mediaPlay('" + baseUrl+ item.jiaochengshipin + "')"
			  jiaochengshipinMedia.setAttribute('onclick',jiaochengshipinAttr);
       		          jiaochengshipinCell.appendChild(jiaochengshipinMedia);


			row.appendChild(jiaochengshipinCell);
			...
			var meishizuofaCell  = document.createElement('td');
	...
	function discussList(id) {
            ...
            window.location.href = "../discussmeishijiaocheng/list.jsp"
        }
		//清除会重复渲染的节点
        function clear(){
