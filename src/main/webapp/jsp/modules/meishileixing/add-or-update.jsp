...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑美食类型</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>美食类型管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑美食类型</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>美食类型</label>
					<input name="meishileixing" id="meishileixing" name="meishileixing" class="form-control" placeholder="请输入美食类型">
				</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "meishileixing/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("meishileixing/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("meishileixing/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("meishileixing/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("meishileixing"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#meishileixing").val(ruleForm.meishileixing);	
		}		
		//图片显示
		function showImg(){
		}		
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.meishileixing != null && res.data.meishileixing != ''){
						...
						$("#meishileixing").val(res.data.meishileixing);
						$("#meishileixing").attr('readonly','readonly');
					}
				}
			});  
            }
